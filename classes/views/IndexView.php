  ...
  <div class="row">
    <div class="offset-lg-2 col-lg-8 bgc-transparent">
      ...
      foreach ($products_expire_soon as $value) {
        ?>
        <div class="alert alert-warning my-2 mx-5 text-center" role="alert">ATTENTION : La garantie du produit <?php echo $value['name'] ?> (<?php echo $value['category'] ?>) acheté le <?php echo $value['purchase_date_fr'] ?> arrive à expiration le <?php echo $value['warranty_date_fr'] ?> !</div>
        <?php
      }
      ?>
      </div>
      ...
      <!-- CLIENT GRAPH -->
      <h1 class="py-1">Your last purchases - Vos derniers achats</h1>
      <p>
        <button id="detail" class="btn" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">
          <i class="far fa-eye"> <span>Afficher les détails</span></i>
        </button>
      </p>
...
>>>>>>> 82b063e4ee1ee63485d83ccc85140ed9ee4daaa8
                            </div>
                          </div>
                        </div>
                      </div>

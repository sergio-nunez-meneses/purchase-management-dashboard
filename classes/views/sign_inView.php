...
class Sign_inView
{
  ...
  public static function sign_in()
  {
    ...
    $specialJS = '<script type="text/javascript"src="public/JS/scriptModalRecupId.js"></script><script type="text/javascript"src="public/JS/scriptCreateAccount.js"></script>'; // ou mettre null si pas de script spécial
